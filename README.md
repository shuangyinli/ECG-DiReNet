...
```bash
  ...
  # Load the npz file
  data = np.load("generate_data.npz")    
  ecg_signals = data['data']  
  labels = data['label']

  idx = np.random.randint(0, len(ecg_signals))  # Randomly select a sample
  plt.plot(ecg_signals[idx], color='blue' if labels[idx]==0 else 'red')
...
<p align="center">
  <a href="./assets/sample.png">  
    <img src="./assets/sample.png" alt="Sample" width="65%"/>
  </a>
  <br>
...
<p align="center">
  <a href="./assets/scatter.png">  
    <img src="./assets/scatter.png" alt="result_scatter" width="70%"/>
  </a>
</p>
